...
activateTriggers :: Types.SingleAssignmentStore -> Types.TriggerStore -> [Types.Memory] -> (Types.TriggerStore, [(Types.Stack, Types.StackState, [Types.EnvironmentMap], [Types.SingleAssignmentStore], [Types.TriggerStore], Types.Identifier)])
...
generateNewStackTuples :: [Types.Value] -> Types.Memory -> [(Types.Stack, Types.StackState, [Types.EnvironmentMap], [Types.SingleAssignmentStore], [Types.TriggerStore], Types.Identifier)]
